...
\begin{document}
	...
	\begin{flushleft}	
		...
		\includegraphics[scale=0.4]{stream.png} \textbf{Hooked}, Remote, USA\\
		\begin{leftli}
		...
		%\vspace{-1mm}
		\includegraphics[scale=0.45]{pitt.png} \textbf{University of Pittsburgh, SCI}, Pittsburgh, PA\\
		\begin{leftli}
		...
		%\vspace{-1.50mm}
		\includegraphics[scale=0.45]{uber.png} \textbf{Uber}, Pittsburgh, PA\\
		\begin{leftli}
		...
		%\vspace{-1.50mm}
		\includegraphics[scale=0.33]{aspace.png} \textbf{Aspace}, Seattle, WA\\
		\begin{leftli}
