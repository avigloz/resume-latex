...
\begin{document}
	...
	\begin{flushleft}	
		...
		\vspace{0.5mm}
		\textbf{Concepts:} REST APIs, RPC, Serverless, Distributed Systems, System Design/Architecture\\
		\vspace{0.5mm}
		...
		\begin{leftli}
			...
			\begin{itemize}
				...
				\vspace{-2mm}
				\item Developing efficient and seamless collection tools for mitigating credit risk
			\end{itemize}
		\end{leftli}

		\vspace{-1.50mm}
		\textbf{Hooked}, Remote from New York, NY\\
		\begin{leftli}
