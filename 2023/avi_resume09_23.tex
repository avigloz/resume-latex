...
\begin{document}
	...
	\begin{flushleft}	
		...
		\vspace{2.25mm}
		\textbf{Programming Languages:} Haskell, Python, JavaScript (Bun, Node.js, Typescript), \href{https://gleam.run/}{Gleam}, C\verb!#!\\
		\vspace{0.5mm}
		\textbf{Concepts:} REST APIs, Distributed Systems, System Design/Architecture, 2FA\\
		\vspace{0.5mm}
		...
		\textbf{Mercury}, {\small remote from New York, NY}\\
		\begin{leftli}
