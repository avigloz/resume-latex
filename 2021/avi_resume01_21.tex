...
\begin{document}
	...
	\begin{flushleft}	
		...
		%{\small \textbf{Notable coursework:} Web Applications, Data Structures, Algorithm Implementation, Intro to OS (Linux kernel), Discrete Mathematics, Formal Methods}
		...
		% may add these back later, but they are not really relevant.
		% \vspace{-1.5mm}
