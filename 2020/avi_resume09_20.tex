...
\begin{document}
	...
	\begin{flushleft}	
		...
		\vspace{0.5mm}
		\textbf{Learning about:} C\texttt{++}, Haskell, Machine Learning, Computer Vision\\
		\vspace{0.5mm}
		\textbf{Technologies:} Git, SQL (MS, My, Postgre), NoSQL (CouchDB, MongoDB), Linux, Azure, \LaTeX\\
		...
		\begin{leftli}
			{\small \textbf{Machine Learning Researcher} \textit{CS Capstone}} \hfill \textit{\small May 2020 --- September 2020}
			\begin{itemize}
